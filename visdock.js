...
var PointerTool = {
    name: "Pointer",
    image: imagePath + "images/cursor.png",
    select: function() {
...
var RectangleTool = {
    name: "Rect",
    image: imagePath + "images/Rectangle.png",
    start: 0,
    bbox: null,
    select: function() {
...
var EllipseTool = {
    name: "Ellipse",
    image: imagePath + "images/Ellipse.png",
    start: 0,
    bellipse: null,
    select: function() {
...
var LassoTool = {
    name: "Lasso",
    image: imagePath + "images/Lasso.png",
   	start: 0,
    segments: 0,
    dragging: 0,
    points: [],
...
var Straight = {
    name: "Straight",
    image: imagePath + "images/straight_line.png",
    start: 0, 
    Line: null,
...
var Polyline = {
    name: "Polyline",
    image: imagePath + "images/PolyLine.png",
    start: 0,
    before: 0,
    segments: 0,
    dragging: 0,
...
var Freeselect = {
    name: "Freeselect",
    image: imagePath + "images/free_select.png",
    start: 0,
    segments: 0,
    dragging: 0,
    points: [],
...
var PolygonTool = {
    name: "Polygon",
    image: imagePath + "images/polygon.png",
    start: 0,
    before: 0,
    segments: 0,
    dragging: 0,
...
var PanZoomTool = {
    name: "PanZoom",
    image: imagePath + "images/Pan.png",
    start: null,
...
var RotateTool = {
    name: "Rotate",
    image: imagePath + "images/rotate.png",
    start: null,
...
var AnnotatedByPointTool = {
	name: "AbyPoint",
	image: imagePath + "images/AnP.png",
	start: null,
	end: [],
	isDrag: false,
	isResize: false,
...
var AnnotatedByAreaTool = {
	name: "AbyArea",
		image: imagePath + "images/AnA.png",
   	start: 0,
    segments: 0,
    dragging: 0,
    points: [],
...
var Toolbox = {
	...
	var MinMax = this.dock.append("polygon")
		...
		var MinMaxImage = MinMax.append("svg:image")
						...
						.attr("height", 24)
						//.attr("id", "arrowimage")
						.attr("xlink:href", imagePath + "images/DownArrow.png");*/
	...
	// Create Checkbox
		...
		.attr("width",15)
		.attr("height",15)
		.attr("xlink:href", imagePath + "images/checkbox_yes.png")
		.on("click",function(){if (Toolbox.inclusive == true){
					    Toolbox.inclusive = false;//alert("0")
					    checked.attr("xlink:href",imagePath + "images/checkbox_no.png")
					    //checked.setAttributeNS(null,"xlink:href", imagePath + "images/checkbox_no.png")
					}
					else{
					    Toolbox.inclusive = true;//alert("1")
					    checked.attr("xlink:href",imagePath + "images/checkbox_yes.png")
					    //checked.setAttributeNS(null,"xlink:href", imagePath + "images/checkbox_yes.png")	
					}
...
//alert("JFKDSLSDDSF")
	...
	trashtool.append("svg:image")
				...
				.attr("width", 20)
				.attr("height", 20)
				.attr("xlink:href", imagePath + "images/Delete.png")
				.on("mousedown", function(){
				//QueryManager.trashtoggle=1;
				//QueryManager.uniontoggle=0;
				//QueryManager.commontoggle=0;
	...
	uniontool.append("svg:image")
				...
				.attr("width", 24)
				.attr("height", 24)
				.attr("xlink:href", imagePath + "images/or.png")
				.on("mousedown", function(){
				var union = []
				for (var j=0;j<QueryManager.querytoggle.length;j++){
				    for (var k=0;k<VisDock.captured[QueryManager.querytoggle[j]].length;k++){
	...
	var common = commontool.append("rect")
		...
		commontool.append("svg:image")
				...
				.attr("width", 24)
				.attr("height", 24)
				.attr("xlink:href", imagePath + "images/and.png")
				.on("mousedown", function(){//alert(QueryManager.querytoggle)
				//QueryManager.trashtoggle=0;
				//QueryManager.uniontoggle=1;
				//QueryManager.commontoggle=0;
...
//	    .attr("x",3*queryWidth/4+this.margin).attr("y",this.margin)
	...
	//alert("common = " + common.length);//alert(union.length)
		...
		xortool.append("svg:image")
				...
				.attr("width", 24)
				.attr("height", 24)
				.attr("xlink:href", imagePath + "images/xor.png")
				.on("mousedown", function(){//alert(QueryManager.querytoggle)
				//QueryManager.trashtoggle=0;
				//QueryManager.uniontoggle=1;
				//QueryManager.commontoggle=0;
